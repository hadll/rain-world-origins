...
public class SpearItemCrafted extends Item implements Vanishable {
    public SpearItemCrafted(Settings settings) {
        super(settings);
    }
    @Override
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        SpearEntity spearEntity = new SpearEntity(world, playerEntity, new ItemStack(Items.AIR), true);
