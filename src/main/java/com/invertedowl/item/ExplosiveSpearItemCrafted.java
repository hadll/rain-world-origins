...
public class ExplosiveSpearItemCrafted extends Item implements Vanishable {
    public ExplosiveSpearItemCrafted(Settings settings) {
        super(settings);
    }
    @Override
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        ExplosiveSpearEntity spearEntity = new ExplosiveSpearEntity(world, playerEntity, new ItemStack(Items.AIR), true);
